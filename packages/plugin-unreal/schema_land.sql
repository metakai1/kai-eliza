...
CREATE TABLE IF NOT EXISTS land_table (
    ...
    CONSTRAINT land_table_userId_fkey FOREIGN KEY ("userId") REFERENCES accounts(id),
    CONSTRAINT land_table_roomId_fkey FOREIGN KEY ("roomId") REFERENCES rooms(id),
    CONSTRAINT land_table_agentId_fkey FOREIGN KEY ("agentId") REFERENCES accounts(id)
);
...
CREATE INDEX IF NOT EXISTS idx_land_table_embedding ON land_table USING hnsw ("embedding" vector_cosine_ops);
CREATE INDEX IF NOT EXISTS idx_land_table_type_room ON land_table("type", "roomId");
